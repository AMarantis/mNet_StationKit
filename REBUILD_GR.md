...
Αυτός ο οδηγός είναι **μόνο** για το PC σου (dev machine), όπου έχεις ήδη εγκατεστημένο Visual Studio IDE και όλα τα components που χρειάζονται. Δεν υποθέτει τίποτα για USB / drive letters κτλ (αυτά αφορούν τους υπολογιστές των σταθμών και καλύπτονται στο `SETUP_GR.md`).
...
- Θα παραχθεί νέο zip διανομής: `mNetStationKit.zip` (στο root του repo)
