...
<link rel="stylesheet" href="Calibration2.css" media="screen">
    ...
    <script type="application/ld+json">{
		...
		"@type": "Organization",
		"name": "mnetOnline",
		"logo": "images/physicslab_logo.png"
}</script>
...
<%--      <asp:Timer ID="Timer2" OnTick="Timer2_Tick" runat="server" Interval="10000" />--%>

        <a href="http://physicslab.eap.gr" class="u-image u-logo u-image-1" data-image-width="868" data-image-height="290" title="physics lab">
          <img src="images/physicslab_logo.png" class="u-logo-image u-logo-image-1" data-image-width="204">
        </a>
...
</li><li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-palette-1-base u-text-body-alt-color u-text-hover-palette-2-base" href="Online-Monitoring" style="padding: 10px 6px;">Online Monitoring</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-white" href="http://telephysics.eap.gr" target="_blank">Telephysics</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Online-Monitoring" style="padding: 10px 6px;">Online Monitoring</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="http://telephysics.eap.gr" target="_blank">Telephysics</a>
        ...
        <div class="u-expanded-width u-tabs u-tabs-1">
          <ul class="u-spacing-15 u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item" role="presentation">
              <a runat="server" onserverclick="Tab_Response_Click" class="active u-active-white u-button-style u-hover-palette-5-light-1 u-palette-5-dark-1 u-tab-link-1" id="linkttab0da5" href="#ttab0da5" role="tab" aria-controls="ttab0da5" aria-selected="false">Detector Response</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a runat="server" onserverclick="Tab_Sync_Click" class="u-active-white u-button-style u-hover-palette-5-light-1 u-palette-5-dark-1 u-tab-link-2" id="linktab14b7" href="#tab14b7" role="tab" aria-controls="tab14b7" aria-selected="true">Synchronization</a>
            </li>
          </ul>
          <div class="u-tab-content">
            <div runat="server" class="u-black u-container-style u-tab-active u-tab-pane u-tab-pane-1" id="ttab0da5" role="tabpanel" aria-labelledby="linkttab0da5">
              <div class="u-container-layout u-container-layout-1">
               <a href="?id=3" class="u-border-6 u-border-palette-4-base u-btn u-btn-round u-button-style u-hover-palette-4-base u-none u-radius-6 u-text-hover-white u-text-white u-btn-1"   >START</a>  
<%--                 <asp:LinkButton ID="linkbtnStart" CssClass="u-border-6 u-border-palette-4-base u-btn u-btn-round u-button-style u-hover-palette-4-base u-none u-radius-6 u-text-hover-white u-text-white u-btn-1" Text="START" onClick="Start_Acquisition_Response" runat="server" ></asp:LinkButton>--%>
                  ...
                  <div class="u-container-layout u-container-layout-2">
                    ...
                    <p class="u-text u-text-3">100.0 mV</p>
                    <p class="u-text u-text-4">Detector Threshold 2</p>
                    <p class="u-text u-text-5">100.0 mV</p>
                    <p class="u-text u-text-6">Detector Threshold 3</p>
                    <p class="u-text u-text-7">100.0 mV</p>
<%--                    <p class="u-text u-text-2">Detector Threshold 1</p>
                    <p class="u-text u-text-3"><asp:TextBox ID="text_thr1" value="5.0" OnTextChanged="text_thr1_changed" AutoPostBack="True" runat="server" ForeColor="Black" Height="30px" Width="55px"></asp:TextBox>mV</p>
                    <p class="u-text u-text-4">Detector Threshold 2</p>
                    <p class="u-text u-text-5"><asp:TextBox ID="text_thr2" value="5.0" OnTextChanged="text_thr2_changed" AutoPostBack="True" runat="server" ForeColor="Black" Height="30px" Width="55px"></asp:TextBox>mV</p>
                    <p class="u-text u-text-6">Detector Threshold 3</p>
                    <p class="u-text u-text-7"><asp:TextBox ID="text_thr3" value="5.0" OnTextChanged="text_thr3_changed" AutoPostBack="True" runat="server" ForeColor="Black" Height="30px" Width="55px"></asp:TextBox>mV</p>--%>
                  </div>
                </div>
                <img class="u-image u-image-default u-image-1" src="images/1.gif" alt="" data-image-width="853" data-image-height="480">
                <a href="?id=4" class="u-border-6 u-border-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-none u-radius-6 u-text-hover-white u-text-white u-btn-2">STOP</a> 
...
<%--                    <img class="u-expanded-width u-image u-image-2" src="images/outroot.jpeg" data-image-width="1496" data-image-height="572">--%>
                    ...
                    <a href="?id=5" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-5-dark-1 u-palette-5-base u-radius-50 u-btn-3">&nbsp &nbsp Clear Mean Pulses &nbsp &nbsp</a>
                    <a href="?id=6" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-5-dark-1 u-palette-5-base u-radius-50 u-btn-4">&nbsp &nbsp &nbsp Clear Distributions &nbsp &nbsp &nbsp</a> 
            ...
            <div runat="server" class="u-align-left u-black u-container-style u-tab-pane u-tab-pane-2" id="tab14b7" role="tabpanel" aria-labelledby="linktab14b7">
              <div class="u-container-layout u-container-layout-4">
                <img class="u-image u-image-default u-image-3" src="images/1.gif" alt="" data-image-width="853" data-image-height="480">
                <a href="?id=1" class="u-border-6 u-border-palette-4-base u-btn u-btn-round u-button-style u-hover-palette-4-base u-none u-radius-6 u-text-hover-white u-text-white u-btn-5">START</a>
    <%--            <asp:LinkButton ID="LinkButton1" CssClass="u-border-6 u-border-palette-4-base u-btn u-btn-round u-button-style u-hover-palette-4-base u-none u-radius-6 u-text-hover-white u-text-white u-btn-5" Text="START" onClick="Start_Acquisition_Sync" runat="server" ></asp:LinkButton> --%>
                <div class="u-black u-border-2 u-border-palette-1-base u-container-style u-group u-shape-rectangle u-group-3">
                  <div class="u-container-layout u-container-layout-5">
                    <p class="u-text u-text-9">Timing Threshold 1</p>
                    <p class="u-text u-text-10">100.0 mV</p>
                    <p class="u-text u-text-11">Detector Threshold 1</p>
                    <p class="u-text u-text-12">200.0 mV</p>
                    <p class="u-text u-text-13">220.0 mV</p>
                    <p class="u-text u-text-14">Detector Threshold 2</p>
                    <p class="u-text u-text-15">120.0 mV</p>
                    <p class="u-text u-text-16">Timing Threshold 2</p>
                    <p class="u-text u-text-17">Timing Threshold 3</p>
                    <p class="u-text u-text-18">130.0 mV</p>
                    <p class="u-text u-text-19">Detector Threshold 3</p>
                    <p class="u-text u-text-20">230.0 mV</p>
<%--                    <p class="u-text u-text-9">Timing Threshold 1</p>
                ...
                <a href="?id=2" class="u-border-6 u-border-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-none u-radius-6 u-text-hover-white u-text-white u-btn-6">STOP</a>
               <%-- <asp:LinkButton ID="LinkButton2" Cssclass="u-border-6 u-border-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-none u-radius-6 u-text-hover-white u-text-white u-btn-6" Text="STOP" onClick="Stop_Acquisition_Sync" runat="server" ></asp:LinkButton> --%>
                ...
                <p class="u-text u-text-21"><asp:Label id="Status_sync" runat="server" Text="StatusSync"></asp:Label></p>
                <a href="?id=7" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-5-dark-1 u-palette-5-base u-radius-50 u-btn-7">Clear Data</a>
    ...
    <footer class="u-align-center-md u-align-center-sm u-align-center-xs u-black u-clearfix u-footer" id="sec-8f2c"><div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
      ...
      </div></footer><span style="height: 64px; width: 64px; margin-left: 0px; margin-right: auto; margin-top: 0px; background-image: none; right: 55px; bottom: 25px;" class="u-back-to-top u-icon u-icon-circle u-opacity u-opacity-85 u-palette-1-base u-spacing-15" data-href="#"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 551.13 551.13" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-e265"></use></svg><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 551.13 551.13" id="svg-e265"><path d="m275.565 189.451 223.897 223.897h51.668l-275.565-275.565-275.565 275.565h51.668z"></path></svg>
