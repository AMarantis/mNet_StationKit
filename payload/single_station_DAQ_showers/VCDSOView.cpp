...
void CVCDSOView::DrawWaveInYT(CDC* pDC,CRect Rect,USHORT nCH)
{
	...
	ULONG nDisDataLen = 4096;//网格内要画的数据长度
	ULONG nSrcDataLen = 2096;// BUF_4K_LEN;//源数据的长度
	USHORT nDisLeverPos = m_pDoc->m_Hard.m_nLeverPos[nCH]+50;//零电平的显示位置
	ULONG nCenterData =(int) BUF_4K_LEN/4.;//
